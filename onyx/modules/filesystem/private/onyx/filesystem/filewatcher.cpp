  ...
  public:
    void handleFileAction( efsw::WatchID /*watchid*/,
        ...
        case efsw::Action::Add:
            fileAction = FileWatcher::FileAction::Add;
            break;
        case efsw::Action::Delete:
            fileAction = FileWatcher::FileAction::Delete;
            break;
        case efsw::Action::Modified:
            fileAction = FileWatcher::FileAction::Modified;
            break;
        case efsw::Action::Moved:
            fileAction = FileWatcher::FileAction::Moved;
            break;
        }
