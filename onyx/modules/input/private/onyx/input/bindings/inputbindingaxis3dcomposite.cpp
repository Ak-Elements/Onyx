...
{
    bool InputBindingAxis3DComposite::DoUpdate(const InputSystem& inputSystem, Vector3f32& outInputValue)
    {
    ...
    InputID InputBindingAxis3DComposite::GetBoundInputForSlot(onyxU32 index) const
    {
        switch (index)
        {
    ...
    void InputBindingAxis3DComposite::SetInputBindingSlot(onyxU32 index, InputID inputID)
    {
        switch (index)
        {
            case 0:
...
namespace Onyx
{
    bool Serialization<Input::InputBindingAxis3DComposite>::Serialize(Serializer& serializer, const Input::InputBindingAxis3DComposite& binding)
    {
    ...
    bool Serialization<Input::InputBindingAxis3DComposite>::Deserialize(const Deserializer& deserializer, Input::InputBindingAxis3DComposite& outBinding)
    {
