...
void* DeviceMemory::Map( MapMode mapMode ) {
    ...
    m_IsWrite = enums::all( mapMode, MapMode::Write );
    return m_MappedPtr;
}
...
void DeviceMemory::GetMemoryPropertyFlags( const CPUAccess& cpuAccess,
    ...
    case CPUAccess::Write:
        ...
        return;
    case CPUAccess::Read:
        outRequired = VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_CACHED_BIT |
    ...
    default:
        outRequired = 0;
        outPreferred = 0;
        ONYX_ASSERT( false, "Unhandled access type {}", static_cast< uint8_t >( cpuAccess ) );
        return;
    }
}
} // namespace onyx::rhi::vulkan
