...
class SwizzleVectorComponentsNode< graphics::ShaderGraphNode, InVectorT, OutVectorT, TypeIdString >
    : public FixedPinNode_1_In_1_Out< graphics::ShaderGraphNode, InVectorT, OutVectorT > {
  public:
...
class GetVector2Components< graphics::ShaderGraphNode, ScalarT, TypeIdString >
    : public FixedPinNode_1_In_2_Out< graphics::ShaderGraphNode, Vector2< ScalarT >, ScalarT, ScalarT > {
  public:
    static constexpr StringId32 TypeId = TypeIdString;
    StringId32 GetTypeId() const override { return TypeId; }
...
class GetVector3Components< graphics::ShaderGraphNode, ScalarT, TypeIdString >
    : public FixedPinNode_1_In_3_Out< graphics::ShaderGraphNode, Vector3< ScalarT >, ScalarT, ScalarT, ScalarT > {
  public:
    static constexpr StringId32 TypeId = TypeIdString;
    StringId32 GetTypeId() const override { return TypeId; }
...
class GetVector4Components< graphics::ShaderGraphNode, ScalarT, TypeIdString >
    : public FixedPinNode_1_In_4_Out< graphics::ShaderGraphNode,
                                      Vector4< ScalarT >,
                                      ScalarT,
                                      ScalarT,
                                      ScalarT,
  ...
  private:
    using Super =
        FixedPinNode_1_In_4_Out< graphics::ShaderGraphNode, Vector4< ScalarT >, ScalarT, ScalarT, ScalarT, ScalarT >;
...
class CreateVector2< graphics::ShaderGraphNode, ScalarT, TypeIdString >
    : public FixedPinNode_2_In_1_Out< graphics::ShaderGraphNode, ScalarT, ScalarT, Vector2< ScalarT > > {
  public:
    static constexpr StringId32 TypeId = TypeIdString;
    StringId32 GetTypeId() const override { return TypeId; }
...
class CreateVector4< graphics::ShaderGraphNode, ScalarT, TypeIdString >
    : public FixedPinNode_4_In_1_Out< graphics::ShaderGraphNode,
                                      ScalarT,
                                      ScalarT,
                                      ScalarT,
                                      ScalarT,
  ...
  private:
    using Super =
        FixedPinNode_4_In_1_Out< graphics::ShaderGraphNode, ScalarT, ScalarT, ScalarT, ScalarT, Vector4< ScalarT > >;
