...
namespace onyx::graphics
{
    ...
    namespace shader_graph_nodes
    {
        ...
        private:
            ...
            using RedOutPin = node_graph::Pin<onyxF32, "R">;
            using GreenOutPin = node_graph::Pin<onyxF32, "G">;
            using BlueOutPin = node_graph::Pin<onyxF32, "B">;
            using AlphaOutPin = node_graph::Pin<onyxF32, "A">;
