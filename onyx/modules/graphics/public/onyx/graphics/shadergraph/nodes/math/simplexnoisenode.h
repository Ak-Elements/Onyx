...
{
    class SimplexNoise2DNode : public node_graph::FixedPinNode_1_In_2_Out<ShaderGraphNode, Vector2f32, onyxF32, Vector2f32>
    {
    private:
        using Super = node_graph::FixedPinNode_1_In_2_Out<ShaderGraphNode, Vector2f32, onyxF32, Vector2f32>;
    public:
    ...
    class SimplexNoise3DNode : public node_graph::FixedPinNode_1_In_2_Out<ShaderGraphNode, Vector3f32, onyxF32, Vector3f32>
    {
    private:
        using Super = node_graph::FixedPinNode_1_In_2_Out<ShaderGraphNode, Vector3f32, onyxF32, Vector3f32>;
    public:
