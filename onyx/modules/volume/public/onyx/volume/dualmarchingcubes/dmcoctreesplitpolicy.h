...
//
const uint8_t EDGE_VERTICES[ 12 ][ 2 ] = {
    { 2, 6 }, // edge 0
    { 0, 4 }, // edge 1
    { 0, 2 }, // edge 2
    { 4, 6 }, // edge 3
...
class DMCOctreeSplitPolicy : public OctreeSplitPolicy< Scalar > {
  ...
  public:
    DMCOctreeSplitPolicy( uint8_t maxOctreeLevel,
                          Scalar octreeRootSize,
                          Scalar maxGeometricError,
                          Scalar sampleResolution,
  ...
  private:
    bool CheckTriplanarGeometricError( const Vector3< Scalar >& from,
                                       const Vector3< Scalar >& center,
                                       const Vector3< Scalar >& to ) {
        const VolumeBase& volumeBase = *( super::m_VolumeSource );
