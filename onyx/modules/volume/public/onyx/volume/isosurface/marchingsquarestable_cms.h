...
static constexpr int8_t MS_TABLE[ 16 ][ 4 ] = {
...
static constexpr int8_t MS_TABLE_AMBIGUOUS[ 16 ][ 4 ] = {
    { -1, -1, -1, -1 }, //  0: configuration 0
...
static constexpr uint8_t VERTEX_MAP[ 4 ][ 2 ] = { { 0, 2 }, { 3, 1 }, { 1, 0 }, { 2, 3 } };

static const uint8_t FACE_AXES[ 6 ][ 2 ] =
    { { 0 | 2, 8 | 4 }, { 8 | 2, 8 | 4 }, { 8 | 1, 8 | 4 }, { 8 | 1, 0 | 4 }, { 8 | 1, 0 | 2 }, { 8 | 1, 8 | 2 } };

// returns the axis to use on this face e.g face 0 x/z
static const uint8_t FACE_COORDS[ 6 ][ 2 ] = {
    { 0, 1 }, // face 0
    { 0, 1 }, // face 1
    { 0, 2 }, // face 2
    { 0, 2 }, // face 3
...
static const uint8_t FACE_EDGE_TO_CUBE_EDGE[ 6 ][ 4 ]{
    { 0, 1, 3, 2 },
    { 4, 5, 7, 6 },
    { 1, 4, 9, 8 },
    { 0, 5, 10, 11 },
...
static const uint8_t NEXT_FACE_EDGE[ 6 ][ 4 ][ 2 ] = {
