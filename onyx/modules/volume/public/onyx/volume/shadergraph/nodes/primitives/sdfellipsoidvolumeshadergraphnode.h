...
class SdfEllipsoidVolumeShaderGraphNode
    : public node_graph::FixedPinNode2In1Out< graphics::ShaderGraphNode, Vector3f32, Vector3f32, SdfSample > {
  private:
    using Super = node_graph::FixedPinNode2In1Out< graphics::ShaderGraphNode, Vector3f32, Vector3f32, SdfSample >;
