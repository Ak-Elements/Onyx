...
{
    class UnionVolumeShaderGraphNode : public NodeGraph::FixedPinNode<Graphics::ShaderGraphNode, 4, 2>
    {
    private:
    ...
    public:
        UnionVolumeShaderGraphNode();
        static constexpr StringId32 TypeId = "Onyx::Volume::VolumeShaderGraph::UnionVolumeShaderGraphNode";
