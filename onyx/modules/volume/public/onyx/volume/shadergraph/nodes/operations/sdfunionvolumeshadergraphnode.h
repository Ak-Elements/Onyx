...
{
    class SdfUnionVolumeShaderGraphNode : public NodeGraph::FixedPinNode<Graphics::ShaderGraphNode, 4, 2>
    {
    private:
    ...
    public:
        static constexpr StringId32 TypeId = "Onyx::Volume::VolumeShaderGraph::SdfUnionVolumeShaderGraphNode";
