...
OctreeBreadthFirstIterator< OctreeT, OctreeNodeT >::OctreeBreadthFirstIterator( OctreeT* octree, uint8_t maxDepth )
...
//////////////////////////////////////////////////////////////////////////////////////////////
template < typename OctreeT, typename OctreeNodeT >
OctreeBreadthFirstIterator< OctreeT, OctreeNodeT >& OctreeBreadthFirstIterator< OctreeT, OctreeNodeT >::operator++() {
    ...
    --state.m_Depth;
    OctreeKey< uint32_t >& key = state.m_Key;
