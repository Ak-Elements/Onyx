...
TreeBreadthFirstIterator< TreeT >::TreeBreadthFirstIterator( TreeT* quadtree, uint8_t maxDepth )
...
//////////////////////////////////////////////////////////////////////////////////////////////
template < typename TreeT >
TreeBreadthFirstIterator< TreeT >& TreeBreadthFirstIterator< TreeT >::operator++() {
    ...
    if ( state.m_Depth > super::m_MaxDepth ) {
        ...
        if ( currentNode->IsBranch() ) {
            ...
            for ( uint8_t i = 0; i < TreeT::NumChildren; ++i ) {
