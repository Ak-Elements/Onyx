...
namespace onyx::volume
{
    ...
    void SdfDifferenceVolumeShaderGraphNode::DoGenerateShader(const node_graph::ExecutionContext& context, rhi::ShaderGenerator& generator) const
    {
    ...
    node_graph::PinBase* SdfDifferenceVolumeShaderGraphNode::GetInputPin(onyxU32 index)
    {
        switch (index)
        {
    ...
    const node_graph::PinBase* SdfDifferenceVolumeShaderGraphNode::GetInputPin(onyxU32 index) const
    {
        switch (index)
        {
        case 0: return &m_IsoValueSource0InPin;
    ...
    node_graph::PinBase* SdfDifferenceVolumeShaderGraphNode::GetOutputPin(onyxU32 index)
    {
    ...
    const node_graph::PinBase* SdfDifferenceVolumeShaderGraphNode::GetOutputPin(onyxU32 index) const
    {
        ONYX_ASSERT(index < GetOutputPinCount(), "Invalid pin index");
        if (index == 0)
            return &m_IsoValueOutPin;
