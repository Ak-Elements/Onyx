...
node_graph::PinBase* SdfUnionVolumeShaderGraphNode::GetInputPin( uint32_t index ) {
    switch ( index ) {
    case 0:
...
const node_graph::PinBase* SdfUnionVolumeShaderGraphNode::GetInputPin( uint32_t index ) const {
    switch ( index ) {
    case 0:
        return &m_IsoValueSource0InPin;
    case 1:
...
node_graph::PinBase* SdfUnionVolumeShaderGraphNode::GetOutputPin( uint32_t index ) {
...
const node_graph::PinBase* SdfUnionVolumeShaderGraphNode::GetOutputPin( uint32_t index ) const {
    ONYX_ASSERT( index < GetOutputPinCount(), "Invalid pin index" );
    if ( index == 0 )
        return &m_IsoValueOutPin;
