...
//
//         float32 GetVelocity() const { return m_Speed; }
//         void SetVelocity(float32 velocity) { m_Speed = std::clamp(velocity, m_MinSpeed, m_MaxSpeed); }
//
//         float32 GetBaseVelocity() const { return m_BaseSpeed; }
//         float32 GetVelocityIncrementFactor() const { return m_SpeedIncrementFactor; }
//
//     private:
...
//         float32 m_BaseSpeed = 0.002f;
//         float32 m_MinSpeed = 0.001f;
//         float32 m_MaxSpeed = 0.3f;
//
//         float32 m_RotationSpeed = 0.3f;
//         float32 m_SpeedIncrementFactor = 0.3f;
//         //
//
//         float32 m_Speed = m_BaseSpeed;
//
//         Vector3f m_Position;
...
//
//         float32 m_PitchDelta = 0.0f;
//         float32 m_YawDelta = 0.0f;
//
