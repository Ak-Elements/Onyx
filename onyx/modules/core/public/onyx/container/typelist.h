...
struct typelist_element< Index, TypeList< First, Other... > > : typelist_element< Index - 1u, TypeList< Other... > > {};
...
constexpr TypeList< Args... > GetFunctionArgumentTypes( Ret ( * )( Args... ) ) {
    return {};
}

// Overload for member functions
template < typename Ret, typename ClassType, typename... Args >
constexpr TypeList< Args... > GetFunctionArgumentTypes( Ret ( ClassType::* )( Args... ) ) {
    return {};
}
