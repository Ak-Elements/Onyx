...
template < typename Scalar >
static bool IsOverlapping( const Vector2< Scalar >& triangle1Point0,
                           const Vector2< Scalar >& triangle1Point1,
                           const Vector2< Scalar >& triangle1Point2,
                           const Vector2< Scalar >& linePoint0,
                           const Vector2< Scalar >& linePoint1 ) {
...
static bool IsOverlapping( const Vector2< Scalar >& triangle1Point0,
                           const Vector2< Scalar >& triangle1Point1,
                           const Vector2< Scalar >& triangle1Point2,
                           const Vector2< Scalar >& triangle2Point0,
                           const Vector2< Scalar >& triangle2Point1,
                           const Vector2< Scalar >& triangle2Point2 ) {
...
static Projection< Scalar > GetProjection( const Triangle< Scalar >& triangle, const Vector2< Scalar >& edgeNormal ) {
    ...
    return Projection< Scalar >( static_cast< float32 >( min ), static_cast< float32 >( max ) );
}
