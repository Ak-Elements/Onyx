...
struct Serialization< input_actions::InputAction > {
    static bool serialize( Serializer& serializer, const input_actions::InputAction& action ) {
        return serializer.write< "id" >( action.m_Id ) && serializer.write< "type" >( action.m_Type ) &&
...
struct Serialization< UniquePtr< input_actions::InputBinding > > {
    static bool serialize( Serializer& serializer, const UniquePtr< input_actions::InputBinding >& binding ) {
        ...
        const input_actions::InputBindingsFactory::MetaData&
            metaData = input_actions::InputBindingsFactory::GetMetaData( binding->GetTypeId() );
...
struct Serialization< UniquePtr< input_actions::InputTrigger > > {
    static bool serialize( Serializer& serializer, const UniquePtr< input_actions::InputTrigger >& modifier ) {
        ...
        const input_actions::InputTriggersFactory::MetaData&
            metaData = input_actions::InputTriggersFactory::GetMetaData( modifier->GetTypeId() );
    ...
    static bool deserialize( const Deserializer& deserializer, UniquePtr< input_actions::InputTrigger >& outModifier ) {
        ...
        const input_actions::InputTriggersFactory::MetaData&
            metaData = input_actions::InputTriggersFactory::GetMetaData( typeId );
...
struct Serialization< UniquePtr< input_actions::InputModifier > > {
    static bool serialize( Serializer& serializer, const UniquePtr< input_actions::InputModifier >& modifier ) {
        serializer.write< "typeId" >( modifier->GetTypeId() );
        const input_actions::InputModifiersFactory::MetaData&
            metaData = input_actions::InputModifiersFactory::GetMetaData( modifier->GetTypeId() );

        return metaData.SerializeFunctor( serializer, modifier );
    }

    static bool deserialize( const Deserializer& deserializer,
                             UniquePtr< input_actions::InputModifier >& outModifier ) {
        StringId32 typeId;
        deserializer.read< "typeId" >( typeId );

        const input_actions::InputModifiersFactory::MetaData&
            metaData = input_actions::InputModifiersFactory::GetMetaData( typeId );
        outModifier = metaData.CreateFunctor();
...
bool InputActionsSerializer::serialize( const assets::AssetHandle< assets::AssetInterface >& asset,
...
bool InputActionsSerializer::deserialize( assets::AssetHandle< assets::AssetInterface >& asset,
                                          const assets::AssetMetaData& meta,
