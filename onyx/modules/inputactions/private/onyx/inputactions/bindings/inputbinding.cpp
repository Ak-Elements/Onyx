...
bool InputBinding::Update( const input::InputSystem& inputSystem,
...
void InputBinding::RemoveTrigger( int32_t index ) {
    ONYX_ASSERT( index < numericCast< int32_t >( m_Triggers.size() ) );
...
void InputBinding::RemoveModifier( int32_t index ) {
    ONYX_ASSERT( index < numericCast< int32_t >( m_Modifiers.size() ) );
