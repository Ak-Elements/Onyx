...
static constexpr uint32_t EXTENDED_KEYMASK = ( 1 << 24 );
static constexpr uint32_t REPEATED_KEYMASK = ( 1 << 30 );

static constexpr input::Key WINDOWS_KEYCODES[] = { input::Key::Invalid,
                                                   input::Key::Escape,
                                                   input::Key::Key1,
                                                   input::Key::Key2,
                                                   input::Key::Key3,
...
inline input::Key VirtualKeyCodeToKey( uint64_t virtualKeyCode ) {
    switch ( virtualKeyCode ) {
    case VK_MODECHANGE:
        return input::Key::Mode;
    case VK_SELECT:
        return input::Key::Select;
    case VK_EXECUTE:
        return input::Key::Execute;
    case VK_HELP:
        return input::Key::Help;
    case VK_PAUSE:
        return input::Key::Pause;
    case VK_NUMLOCK:
        return input::Key::NumPad_Lock_Clear;
    ...
    case VK_OEM_NEC_EQUAL:
        return input::Key::NumPad_Equals;
    case VK_BROWSER_BACK:
        return input::Key::AppControl_Back;
    case VK_BROWSER_FORWARD:
        return input::Key::AppControl_Forward;
    case VK_BROWSER_REFRESH:
        return input::Key::AppControl_Refresh;
    case VK_BROWSER_STOP:
        return input::Key::AppControl_Stop;
    case VK_BROWSER_SEARCH:
        return input::Key::AppControl_Search;
    case VK_BROWSER_FAVORITES:
        return input::Key::AppControl_Bookmarks;
    case VK_BROWSER_HOME:
        return input::Key::AppControl_Home;
    case VK_VOLUME_MUTE:
        return input::Key::Audio_Mute;
    case VK_VOLUME_DOWN:
        return input::Key::VolumeDown;
    case VK_VOLUME_UP:
        return input::Key::VolumeUp;

    case VK_MEDIA_NEXT_TRACK:
        return input::Key::Audio_Next;
    case VK_MEDIA_PREV_TRACK:
        return input::Key::Audio_Previous;
    case VK_MEDIA_STOP:
        return input::Key::Audio_Stop;
    case VK_MEDIA_PLAY_PAUSE:
        return input::Key::Audio_Play;
    case VK_LAUNCH_MAIL:
        return input::Key::Mail;
    case VK_LAUNCH_MEDIA_SELECT:
        return input::Key::Media_Select;

    case VK_OEM_102:
        return input::Key::NonUsBackSlash;

    case VK_ATTN:
        return input::Key::SysReq;
    case VK_CRSEL:
        return input::Key::CrSel;
    case VK_EXSEL:
        return input::Key::ExSel;
    case VK_OEM_CLEAR:
        return input::Key::Clear;

    case VK_LAUNCH_APP1:
        return input::Key::Application1;
    case VK_LAUNCH_APP2:
        return input::Key::Application2;
...
inline input::Key VirtualKeyCodeToKeyFallback( uint64_t virtualKeyCode ) {
    switch ( virtualKeyCode ) {
    case VK_LEFT:
...
inline bool IsKeyRepeated( uint64_t lParam ) {
    return ( lParam & REPEATED_KEYMASK ) != 0;
}
inline input::Key ConvertWindowsKey( uint64_t wParam, uint64_t lParam ) {
    uint64_t virtualKeyCode = wParam;
