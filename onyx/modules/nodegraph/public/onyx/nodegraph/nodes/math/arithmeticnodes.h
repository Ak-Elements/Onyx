...
namespace Nodes {
// Addition
using AddNodeF32 = AddNode< Node, float32, "onyx::NodeGraph::Nodes::AdditionF32" >;
using AddNodeF64 = AddNode< Node, float64, "onyx::NodeGraph::Nodes::AdditionF64" >;
using AddNodeS32 = AddNode< Node, int32_t, "onyx::NodeGraph::Nodes::AdditionS32" >;
using AddNodeS64 = AddNode< Node, int64_t, "onyx::NodeGraph::Nodes::AdditionS64" >;
...
//// Subtraction
using SubtractNodeF32 = SubtractNode< Node, float32, "onyx::NodeGraph::Nodes::SubtractF32" >;
using SubtractNodeF64 = SubtractNode< Node, float64, "onyx::NodeGraph::Nodes::SubtractF64" >;
using SubtractNodeS32 = SubtractNode< Node, int32_t, "onyx::NodeGraph::Nodes::SubtractS32" >;
using SubtractNodeS64 = SubtractNode< Node, int64_t, "onyx::NodeGraph::Nodes::SubtractS64" >;
...
//// Multiplication
using MultiplyNodeF32 = MultiplyNode< Node, float32, "onyx::NodeGraph::Nodes::MultiplyF32" >;
using MultiplyNodeF64 = MultiplyNode< Node, float64, "onyx::NodeGraph::Nodes::MultiplyF64" >;
using MultiplyNodeS32 = MultiplyNode< Node, int32_t, "onyx::NodeGraph::Nodes::MultiplyS32" >;
using MultiplyNodeS64 = MultiplyNode< Node, int64_t, "onyx::NodeGraph::Nodes::MultiplyS64" >;

//// Division
using DivisionNodeF32 = DivisionNode< Node, float32, "onyx::NodeGraph::Nodes::DivideF32" >;
using DivisionNodeF64 = DivisionNode< Node, float64, "onyx::NodeGraph::Nodes::DivideF64" >;
using DivisionNodeS32 = DivisionNode< Node, int32_t, "onyx::NodeGraph::Nodes::DivideS32" >;
using DivisionNodeS64 = DivisionNode< Node, int64_t, "onyx::NodeGraph::Nodes::DivideS64" >;

using AbsoluteNodeF32 = AbsoluteNode< Node, float32, "onyx::NodeGraph::Nodes::AbsoluteF32" >;
using AbsoluteNodeF64 = AbsoluteNode< Node, float64, "onyx::NodeGraph::Nodes::AbsoluteF64" >;
using AbsoluteNodeS32 = AbsoluteNode< Node, int32_t, "onyx::NodeGraph::Nodes::AbsoluteS32" >;
using AbsoluteNodeS64 = AbsoluteNode< Node, int64_t, "onyx::NodeGraph::Nodes::AbsoluteS64" >;
