...
TEMPLATE_TEST_CASE( "Vector2 Constructor",
...
TEMPLATE_TEST_CASE( "Vector2 Comparision",
...
TEMPLATE_TEST_CASE( "Vector2 Arithmetic",
                    "[Vector2][Arithmetic][template]",
                    Vector2f,
                    Vector2d,
                    Vector2s8,
                    Vector2s16,
...
TEMPLATE_TEST_CASE( "Vector2 Dot Product",
                    "[Vector2][DotProduct][template]",
                    Vector2f,
                    Vector2d,
                    Vector2s8,
                    Vector2s16,
...
TEMPLATE_TEST_CASE( "Vector2 Normalize",
                    "[Vector2][Normalize][template]",
                    Vector2s8,
                    Vector2s16,
                    Vector2s32,
                    Vector2u8,
...
TEMPLATE_TEST_CASE( "Vector2 Length",
                    "[Vector2][Length][template]",
                    Vector2f,
                    Vector2d,
                    Vector2s8,
                    Vector2s16,
...
TEMPLATE_TEST_CASE( "Vector2 Rotate",
                    "[Vector2][Rotate][template]",
                    Vector2f,
                    Vector2d,
                    Vector2s8,
                    Vector2s16,
    ...
    Matrix2< RotatedVectorScalarT > rotationMatrix{ cosAlpha, -sinAlpha, sinAlpha, cosAlpha };
...
TEMPLATE_TEST_CASE( "Vector2 Rotate To",
                    "[Vector2][Rotate][template]",
                    Vector2f,
                    Vector2d,
                    Vector2s8,
    ...
    auto values = GENERATE_COPY(
        take( 100,
              filter(
                  ...
                  chunk( 4, random< ScalarT >( static_cast< ScalarT >( -100 ), static_cast< ScalarT >( 100 ) ) ) ) ) );
